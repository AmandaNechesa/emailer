...
//            create SESSION DB
    ...
    private void showMainStage(
        ...
        mainStage.setTitle(Settings.appName.toUpperCase() + " SYSTEM ".toUpperCase());
    ...
    private void showSplash(
        ...
        initStage.getIcons().add(new Image(Settings.APPLICATION_ICON));
        initStage.setResizable(false);
        initStage.setTitle(Settings.appName);
